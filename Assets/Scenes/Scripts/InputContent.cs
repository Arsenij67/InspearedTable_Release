...

{
    ...
    public override void ShowContent()
    {
        ...
        if (NumberCont > 0)
        {
            ...
            Info.GetComponent<LocaledText>().UpdateText(contents[index]); // ?????????? ??? ????????? ???????
        ...
        {
           Info.GetComponent<LocaledText>().UpdateText("Запас мотивация закончился!");
...
public class Joke : Content//1
{
    ...
    public override void ShowContent()
    {
        ...
        {
            Info.GetComponent<LocaledText>().UpdateText("Запас шуток закончился!");
...
public class Story : Content //0
{
    ...
    public override void ShowContent()
    {
        ...
        {
            Info.GetComponent<LocaledText>().UpdateText("Запас историй закончился!");
        }
